 ...
 */
open class NSDatePicker(override val ptr: MemorySegment) : NSControl(ptr) {
    companion object {
    ...
    open fun presentsCalendarOverlay(): Boolean {
        val sel = ObjCRuntime.sel("presentsCalendarOverlay")
        return ObjCRuntime.msgSend(ValueLayout.JAVA_BOOLEAN, ptr, sel) as Boolean
    }
    open fun setPresentsCalendarOverlay(value: Boolean) {
