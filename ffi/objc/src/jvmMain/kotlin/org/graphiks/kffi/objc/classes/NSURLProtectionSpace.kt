...
open class NSURLProtectionSpace(val ptr: MemorySegment) {
    ...
    fun initWithHost_port_protocol_realm_authenticationMethod(host: MemorySegment, port: NSInteger, protocol: MemorySegment, realm: MemorySegment, authenticationMethod: MemorySegment): MemorySegment {
    ...
    fun initWithHost_port_protocol_realm_authenticationMethod(host: String, port: NSInteger, protocol: String, realm: String, authenticationMethod: String): MemorySegment = initWithHost_port_protocol_realm_authenticationMethod(ObjCRuntime.newNSString(Arena.global(), host), port, ObjCRuntime.newNSString(Arena.global(), protocol), ObjCRuntime.newNSString(Arena.global(), realm), ObjCRuntime.newNSString(Arena.global(), authenticationMethod))
    
    fun initWithProxyHost_port_type_realm_authenticationMethod(host: MemorySegment, port: NSInteger, type: MemorySegment, realm: MemorySegment, authenticationMethod: MemorySegment): MemorySegment {
    ...
    // @property proxyType
    fun proxyType(): MemorySegment {
        val sel = ObjCRuntime.sel("proxyType")
        return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel) as MemorySegment
    }
    
    /** Convenience overload — returns Kotlin [String] by converting the NSString via UTF8String. */
    fun proxyTypeAsString(): String = ObjCRuntime.toJavaString(proxyType())
    ...
    /** Convenience overload — returns Kotlin [String] by converting the NSString via UTF8String. */
    fun protocolAsString(): String = ObjCRuntime.toJavaString(protocol())
    
    // @property authenticationMethod
    fun authenticationMethod(): MemorySegment {
        val sel = ObjCRuntime.sel("authenticationMethod")
        return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel) as MemorySegment
    }
    
    /** Convenience overload — returns Kotlin [String] by converting the NSString via UTF8String. */
    fun authenticationMethodAsString(): String = ObjCRuntime.toJavaString(authenticationMethod())
