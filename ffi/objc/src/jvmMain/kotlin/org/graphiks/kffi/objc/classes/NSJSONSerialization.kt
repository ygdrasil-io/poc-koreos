...
open class NSJSONSerialization(val ptr: MemorySegment) {
    companion object {
        ...
        open fun isValidJSONObject(obj: MemorySegment): BOOL {
            val sel = ObjCRuntime.sel("isValidJSONObject:")
            return ObjCRuntime.msgSend(ValueLayout.JAVA_BOOLEAN, _class, sel, obj) as BOOL
        }
        
        open fun dataWithJSONObject_options_error(obj: MemorySegment, opt: NSJSONWritingOptions, error: MemorySegment): MemorySegment {
        ...
        open fun JSONObjectWithData_options_error(`data`: MemorySegment, opt: NSJSONReadingOptions, error: MemorySegment): MemorySegment {
        ...
        open fun writeJSONObject_toStream_options_error(obj: MemorySegment, stream: MemorySegment, opt: NSJSONWritingOptions, error: MemorySegment): NSInteger {
        ...
        open fun JSONObjectWithStream_options_error(stream: MemorySegment, opt: NSJSONReadingOptions, error: MemorySegment): MemorySegment {
