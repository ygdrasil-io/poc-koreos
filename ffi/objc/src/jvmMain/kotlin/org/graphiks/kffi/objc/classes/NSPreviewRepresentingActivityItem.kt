...
open class NSPreviewRepresentingActivityItem(val ptr: MemorySegment) {
    ...
    fun initWithItem_title_image_icon(item: MemorySegment, title: MemorySegment, image: MemorySegment, icon: MemorySegment): MemorySegment {
    ...
    fun initWithItem_title_imageProvider_iconProvider(item: MemorySegment, title: MemorySegment, imageProvider: MemorySegment, iconProvider: MemorySegment): MemorySegment {
