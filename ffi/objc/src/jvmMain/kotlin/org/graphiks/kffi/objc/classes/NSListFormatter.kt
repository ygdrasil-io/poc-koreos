 ...
 */
open class NSListFormatter(ptr: MemorySegment) : NSFormatter(ptr) {
    companion object {
    ...
    fun stringFromItems(items: MemorySegment): MemorySegment {
    ...
    fun itemFormatter(): MemorySegment {
        val sel = ObjCRuntime.sel("itemFormatter")
        return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel) as MemorySegment
    }
    fun setItemFormatter(value: MemorySegment) {
