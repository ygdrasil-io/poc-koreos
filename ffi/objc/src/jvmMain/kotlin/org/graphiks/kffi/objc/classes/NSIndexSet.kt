...
open class NSIndexSet(val ptr: MemorySegment) {
    companion object {
        ...
        open fun indexSet(): MemorySegment {
            val sel = ObjCRuntime.sel("indexSet")
            return ObjCRuntime.msgSend(ValueLayout.ADDRESS, _class, sel) as MemorySegment
        }
        
        open fun indexSetWithIndex(value: NSUInteger): MemorySegment {
        ...
        open fun indexSetWithIndexesInRange(range: NSRange): MemorySegment {
    ...
    open fun indexLessThanIndex(value: NSUInteger): NSUInteger {
        val sel = ObjCRuntime.sel("indexLessThanIndex:")
        return ObjCRuntime.msgSend(ValueLayout.JAVA_LONG, ptr, sel, value) as NSUInteger
    }
    
    open fun indexGreaterThanOrEqualToIndex(value: NSUInteger): NSUInteger {
        val sel = ObjCRuntime.sel("indexGreaterThanOrEqualToIndex:")
        return ObjCRuntime.msgSend(ValueLayout.JAVA_LONG, ptr, sel, value) as NSUInteger
    }
    
    open fun indexLessThanOrEqualToIndex(value: NSUInteger): NSUInteger {
        val sel = ObjCRuntime.sel("indexLessThanOrEqualToIndex:")
        return ObjCRuntime.msgSend(ValueLayout.JAVA_LONG, ptr, sel, value) as NSUInteger
    }
    
    open fun getIndexes_maxCount_inIndexRange(indexBuffer: MemorySegment, bufferSize: NSUInteger, range: MemorySegment): NSUInteger {
    ...
    open fun countOfIndexesInRange(range: NSRange): NSUInteger {
    ...
    open fun containsIndexes(indexSet: MemorySegment): BOOL {
        val sel = ObjCRuntime.sel("containsIndexes:")
        return ObjCRuntime.msgSend(ValueLayout.JAVA_BOOLEAN, ptr, sel, indexSet) as BOOL
    }
    
    open fun intersectsIndexesInRange(range: NSRange): BOOL {
    ...
    open fun indexPassingTest(predicate: MemorySegment): NSUInteger {
        val sel = ObjCRuntime.sel("indexPassingTest:")
        return ObjCRuntime.msgSend(ValueLayout.JAVA_LONG, ptr, sel, predicate) as NSUInteger
    }
    
    open fun indexWithOptions_passingTest(opts: NSEnumerationOptions, predicate: MemorySegment): NSUInteger {
    ...
    open fun indexInRange_options_passingTest(range: NSRange, opts: NSEnumerationOptions, predicate: MemorySegment): NSUInteger {
    ...
    // @property firstIndex
    open fun firstIndex(): NSUInteger {
        val sel = ObjCRuntime.sel("firstIndex")
        return ObjCRuntime.msgSend(ValueLayout.JAVA_LONG, ptr, sel) as NSUInteger
    }
    
    // @property lastIndex
    open fun lastIndex(): NSUInteger {
