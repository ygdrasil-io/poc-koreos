 ...
 */
open class NSNameSpecifier(ptr: MemorySegment) : NSScriptObjectSpecifier(ptr) {
    companion object {
    ...
    fun initWithContainerClassDescription_containerSpecifier_key_name(classDesc: MemorySegment, container: MemorySegment, property: MemorySegment, name: MemorySegment): MemorySegment {
