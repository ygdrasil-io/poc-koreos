...
open class NSTextSelectionNavigation(val ptr: MemorySegment) {
    ...
    open fun destinationSelectionForTextSelection_direction_destination_extending_confined(textSelection: MemorySegment, direction: NSTextSelectionNavigationDirection, destination: NSTextSelectionNavigationDestination, extending: BOOL, confined: BOOL): MemorySegment {
    ...
    open fun deletionRangesForTextSelection_direction_destination_allowsDecomposition(textSelection: MemorySegment, direction: NSTextSelectionNavigationDirection, destination: NSTextSelectionNavigationDestination, allowsDecomposition: BOOL): MemorySegment {
