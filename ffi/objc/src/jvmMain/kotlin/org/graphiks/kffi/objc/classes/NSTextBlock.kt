...
open class NSTextBlock(val ptr: MemorySegment) {
    ...
    fun setValue_type_forDimension(`val`: CGFloat, type: NSTextBlockValueType, dimension: NSTextBlockDimension): Unit {
        val sel = ObjCRuntime.sel("setValue:type:forDimension:")
        ObjCRuntime.msgSend(null, ptr, sel, `val`, type, dimension)
    }
    
    fun valueForDimension(dimension: NSTextBlockDimension): CGFloat {
        val sel = ObjCRuntime.sel("valueForDimension:")
        return ObjCRuntime.msgSend(ValueLayout.JAVA_DOUBLE, ptr, sel, dimension) as CGFloat
    }
    
    fun valueTypeForDimension(dimension: NSTextBlockDimension): NSTextBlockValueType {
    ...
    fun setContentWidth_type(`val`: CGFloat, type: NSTextBlockValueType): Unit {
        val sel = ObjCRuntime.sel("setContentWidth:type:")
        ObjCRuntime.msgSend(null, ptr, sel, `val`, type)
    }
    
    fun setWidth_type_forLayer_edge(`val`: CGFloat, type: NSTextBlockValueType, layer: NSTextBlockLayer, edge: NSRectEdge): Unit {
        val sel = ObjCRuntime.sel("setWidth:type:forLayer:edge:")
        ObjCRuntime.msgSend(null, ptr, sel, `val`, type, layer, edge)
    }
    
    fun setWidth_type_forLayer(`val`: CGFloat, type: NSTextBlockValueType, layer: NSTextBlockLayer): Unit {
        val sel = ObjCRuntime.sel("setWidth:type:forLayer:")
        ObjCRuntime.msgSend(null, ptr, sel, `val`, type, layer)
    }
    
    fun widthForLayer_edge(layer: NSTextBlockLayer, edge: NSRectEdge): CGFloat {
    ...
    fun widthValueTypeForLayer_edge(layer: NSTextBlockLayer, edge: NSRectEdge): NSTextBlockValueType {
    ...
    fun setBorderColor_forEdge(color: MemorySegment, edge: NSRectEdge): Unit {
        val sel = ObjCRuntime.sel("setBorderColor:forEdge:")
        ObjCRuntime.msgSend(null, ptr, sel, color, edge)
    }
    
    fun setBorderColor(color: MemorySegment): Unit {
        val sel = ObjCRuntime.sel("setBorderColor:")
        ObjCRuntime.msgSend(null, ptr, sel, color)
    }
    
    fun borderColorForEdge(edge: NSRectEdge): MemorySegment {
        val sel = ObjCRuntime.sel("borderColorForEdge:")
        return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, edge) as MemorySegment
    }
    
    fun rectForLayoutAtPoint_inRect_textContainer_characterRange(startingPoint: NSPoint, rect: NSRect, textContainer: MemorySegment, charRange: NSRange): NSRect {
    ...
    fun boundsRectForContentRect_inRect_textContainer_characterRange(contentRect: NSRect, rect: NSRect, textContainer: MemorySegment, charRange: NSRange): NSRect {
    ...
    fun drawBackgroundWithFrame_inView_characterRange_layoutManager(frameRect: NSRect, controlView: MemorySegment, charRange: NSRange, layoutManager: MemorySegment): Unit {
    ...
    fun verticalAlignment(): NSTextBlockVerticalAlignment {
    ...
    fun setVerticalAlignment(value: NSTextBlockVerticalAlignment) {
