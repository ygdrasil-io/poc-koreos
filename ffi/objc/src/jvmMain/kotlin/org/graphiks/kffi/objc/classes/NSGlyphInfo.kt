...
open class NSGlyphInfo(val ptr: MemorySegment) {
    companion object {
        ...
        fun glyphInfoWithCGGlyph_forFont_baseString(glyph: CGGlyph, font: MemorySegment, string: MemorySegment): MemorySegment {
        ...
        fun glyphInfoWithCGGlyph_forFont_baseString(glyph: CGGlyph, font: MemorySegment, string: String): MemorySegment = glyphInfoWithCGGlyph_forFont_baseString(glyph, font, ObjCRuntime.newNSString(Arena.global(), string))
    ...
    // @property baseString
    fun baseString(): MemorySegment {
        val sel = ObjCRuntime.sel("baseString")
        return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel) as MemorySegment
    }
    
    /** Convenience overload — returns Kotlin [String] by converting the NSString via UTF8String. */
    fun baseStringAsString(): String = ObjCRuntime.toJavaString(baseString())
