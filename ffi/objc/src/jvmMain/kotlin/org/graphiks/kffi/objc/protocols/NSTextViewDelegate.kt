...
interface NSTextViewDelegate : NSTextDelegate {
    // @optional
    fun textView_clickedOnLink_atIndex(textView: MemorySegment, link: MemorySegment, charIndex: NSUInteger): BOOL =
        throw UnsupportedOperationException("Optional ObjC method 'textView:clickedOnLink:atIndex:' not implemented")
    
    // @optional
    fun textView_clickedOnCell_inRect_atIndex(textView: MemorySegment, cell: MemorySegment, cellFrame: NSRect, charIndex: NSUInteger): Unit =
        throw UnsupportedOperationException("Optional ObjC method 'textView:clickedOnCell:inRect:atIndex:' not implemented")
    
    // @optional
    fun textView_doubleClickedOnCell_inRect_atIndex(textView: MemorySegment, cell: MemorySegment, cellFrame: NSRect, charIndex: NSUInteger): Unit =
        throw UnsupportedOperationException("Optional ObjC method 'textView:doubleClickedOnCell:inRect:atIndex:' not implemented")
    
    // @optional
    fun textView_draggedCell_inRect_event_atIndex(view: MemorySegment, cell: MemorySegment, rect: NSRect, event: MemorySegment, charIndex: NSUInteger): Unit =
    ...
    // @optional
    fun textView_writablePasteboardTypesForCell_atIndex(view: MemorySegment, cell: MemorySegment, charIndex: NSUInteger): MemorySegment =
        throw UnsupportedOperationException("Optional ObjC method 'textView:writablePasteboardTypesForCell:atIndex:' not implemented")
    
    // @optional
    fun textView_writeCell_atIndex_toPasteboard_type(view: MemorySegment, cell: MemorySegment, charIndex: NSUInteger, pboard: MemorySegment, type: NSPasteboardType): BOOL =
    ...
    // @optional
    fun textView_shouldChangeTextInRanges_replacementStrings(textView: MemorySegment, affectedRanges: MemorySegment, replacementStrings: MemorySegment): BOOL =
    ...
    // @optional
    fun textView_willDisplayToolTip_forCharacterAtIndex(textView: MemorySegment, tooltip: MemorySegment, characterIndex: NSUInteger): MemorySegment =
    ...
    // @optional
    fun textView_shouldChangeTextInRange_replacementString(textView: MemorySegment, affectedCharRange: NSRange, replacementString: MemorySegment): BOOL =
    ...
    // @optional
    fun textView_doCommandBySelector(textView: MemorySegment, commandSelector: MemorySegment): BOOL =
        throw UnsupportedOperationException("Optional ObjC method 'textView:doCommandBySelector:' not implemented")
    
    // @optional
    fun textView_shouldSetSpellingState_range(textView: MemorySegment, value: NSInteger, affectedCharRange: NSRange): NSInteger =
        throw UnsupportedOperationException("Optional ObjC method 'textView:shouldSetSpellingState:range:' not implemented")
    
    // @optional
    fun textView_menu_forEvent_atIndex(view: MemorySegment, menu: MemorySegment, event: MemorySegment, charIndex: NSUInteger): MemorySegment =
    ...
    // @optional
    fun textView_didCheckTextInRange_types_options_results_orthography_wordCount(view: MemorySegment, range: NSRange, checkingTypes: NSTextCheckingTypes, options: MemorySegment, results: MemorySegment, orthography: MemorySegment, wordCount: NSInteger): MemorySegment =
    ...
    // @optional
    fun textView_URLForContentsOfTextAttachment_atIndex(textView: MemorySegment, textAttachment: MemorySegment, charIndex: NSUInteger): MemorySegment =
    ...
    // @optional
    fun textView_shouldSelectCandidateAtIndex(textView: MemorySegment, index: NSUInteger): BOOL =
    ...
    // @optional
    fun textView_clickedOnLink(textView: MemorySegment, link: MemorySegment): BOOL =
