...
open class NSColorList(val ptr: MemorySegment) {
    companion object {
        ...
        fun colorListNamed(name: NSColorListName): MemorySegment {
    ...
    fun initWithName(name: NSColorListName): MemorySegment {
        val sel = ObjCRuntime.sel("initWithName:")
        return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, name) as MemorySegment
    }
    
    fun initWithName_fromFile(name: NSColorListName, path: MemorySegment): MemorySegment {
