...
open class NSUbiquitousKeyValueStore(val ptr: MemorySegment) {
    ...
    fun stringForKey(aKey: MemorySegment): MemorySegment {
    ...
    fun arrayForKey(aKey: MemorySegment): MemorySegment {
    ...
    fun dictionaryForKey(aKey: MemorySegment): MemorySegment {
    ...
    fun dataForKey(aKey: MemorySegment): MemorySegment {
    ...
    fun longLongForKey(aKey: MemorySegment): Long {
    ...
    fun doubleForKey(aKey: MemorySegment): Double {
    ...
    fun boolForKey(aKey: MemorySegment): BOOL {
        val sel = ObjCRuntime.sel("boolForKey:")
        return ObjCRuntime.msgSend(ValueLayout.JAVA_BOOLEAN, ptr, sel, aKey) as BOOL
    }
    
    /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
    fun boolForKey(aKey: String): BOOL = boolForKey(ObjCRuntime.newNSString(Arena.global(), aKey))
    
    fun setString_forKey(aString: MemorySegment, aKey: MemorySegment): Unit {
    ...
    fun setData_forKey(aData: MemorySegment, aKey: MemorySegment): Unit {
    ...
    fun setArray_forKey(anArray: MemorySegment, aKey: MemorySegment): Unit {
    ...
    fun setDictionary_forKey(aDictionary: MemorySegment, aKey: MemorySegment): Unit {
    ...
    fun setLongLong_forKey(value: Long, aKey: MemorySegment): Unit {
    ...
    fun setDouble_forKey(value: Double, aKey: MemorySegment): Unit {
    ...
    fun setBool_forKey(value: BOOL, aKey: MemorySegment): Unit {
        val sel = ObjCRuntime.sel("setBool:forKey:")
        ObjCRuntime.msgSend(null, ptr, sel, value, aKey)
    }
    
    /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
    fun setBool_forKey(value: BOOL, aKey: String): Unit = setBool_forKey(value, ObjCRuntime.newNSString(Arena.global(), aKey))
