...
open class NSPort(val ptr: MemorySegment) {
    ...
    open fun scheduleInRunLoop_forMode(runLoop: MemorySegment, mode: NSRunLoopMode): Unit {
        val sel = ObjCRuntime.sel("scheduleInRunLoop:forMode:")
        ObjCRuntime.msgSend(null, ptr, sel, runLoop, mode)
    }
    
    open fun removeFromRunLoop_forMode(runLoop: MemorySegment, mode: NSRunLoopMode): Unit {
        val sel = ObjCRuntime.sel("removeFromRunLoop:forMode:")
        ObjCRuntime.msgSend(null, ptr, sel, runLoop, mode)
    }
    
    open fun sendBeforeDate_components_from_reserved(limitDate: MemorySegment, components: MemorySegment, receivePort: MemorySegment, headerSpaceReserved: NSUInteger): BOOL {
    ...
    open fun sendBeforeDate_msgid_components_from_reserved(limitDate: MemorySegment, msgID: NSUInteger, components: MemorySegment, receivePort: MemorySegment, headerSpaceReserved: NSUInteger): BOOL {
    ...
    open fun addConnection_toRunLoop_forMode(conn: MemorySegment, runLoop: MemorySegment, mode: NSRunLoopMode): Unit {
        val sel = ObjCRuntime.sel("addConnection:toRunLoop:forMode:")
        ObjCRuntime.msgSend(null, ptr, sel, conn, runLoop, mode)
    }
    
    open fun removeConnection_fromRunLoop_forMode(conn: MemorySegment, runLoop: MemorySegment, mode: NSRunLoopMode): Unit {
    ...
    open fun reservedSpaceLength(): NSUInteger {
