 ...
 */
interface NSSpellServerDelegate : NSObject {
    // @optional
    fun spellServer_findMisspelledWordInString_language_wordCount_countOnly(sender: MemorySegment, stringToCheck: MemorySegment, language: MemorySegment, wordCount: MemorySegment, countOnly: BOOL): NSRange =
    ...
    // @optional
    fun spellServer_checkString_offset_types_options_orthography_wordCount(sender: MemorySegment, stringToCheck: MemorySegment, offset: NSUInteger, checkingTypes: NSTextCheckingTypes, options: MemorySegment, orthography: MemorySegment, wordCount: MemorySegment): MemorySegment =
    ...
    // @optional
    fun spellServer_recordResponse_toCorrection_forWord_language(sender: MemorySegment, response: NSUInteger, correction: MemorySegment, word: MemorySegment, language: MemorySegment): Unit =
