...
open class NSLinguisticTagger(val ptr: MemorySegment) {
    companion object {
        ...
        fun tagForString_atIndex_unit_scheme_orthography_tokenRange(string: MemorySegment, charIndex: NSUInteger, unit: NSLinguisticTaggerUnit, scheme: NSLinguisticTagScheme, orthography: MemorySegment, tokenRange: MemorySegment): NSLinguisticTag {
        ...
        fun tagsForString_range_unit_scheme_options_orthography_tokenRanges(string: MemorySegment, range: NSRange, unit: NSLinguisticTaggerUnit, scheme: NSLinguisticTagScheme, options: NSLinguisticTaggerOptions, orthography: MemorySegment, tokenRanges: MemorySegment): MemorySegment {
        ...
        fun enumerateTagsForString_range_unit_scheme_options_orthography_usingBlock(string: MemorySegment, range: NSRange, unit: NSLinguisticTaggerUnit, scheme: NSLinguisticTagScheme, options: NSLinguisticTaggerOptions, orthography: MemorySegment, block: MemorySegment): Unit {
    ...
    fun initWithTagSchemes_options(tagSchemes: MemorySegment, opts: NSUInteger): MemorySegment {
    ...
    fun setOrthography_range(orthography: MemorySegment, range: NSRange): Unit {
    ...
    fun orthographyAtIndex_effectiveRange(charIndex: NSUInteger, effectiveRange: MemorySegment): MemorySegment {
    ...
    fun stringEditedInRange_changeInLength(newRange: NSRange, delta: NSInteger): Unit {
    ...
    fun tokenRangeAtIndex_unit(charIndex: NSUInteger, unit: NSLinguisticTaggerUnit): NSRange {
    ...
    fun sentenceRangeForRange(range: NSRange): NSRange {
    ...
    fun enumerateTagsInRange_unit_scheme_options_usingBlock(range: NSRange, unit: NSLinguisticTaggerUnit, scheme: NSLinguisticTagScheme, options: NSLinguisticTaggerOptions, block: MemorySegment): Unit {
    ...
    fun tagAtIndex_unit_scheme_tokenRange(charIndex: NSUInteger, unit: NSLinguisticTaggerUnit, scheme: NSLinguisticTagScheme, tokenRange: MemorySegment): NSLinguisticTag {
    ...
    /** @return NSArray<NSLinguisticTag> * */
    fun tagsInRange_unit_scheme_options_tokenRanges(range: NSRange, unit: NSLinguisticTaggerUnit, scheme: NSLinguisticTagScheme, options: NSLinguisticTaggerOptions, tokenRanges: MemorySegment): MemorySegment {
    ...
    fun enumerateTagsInRange_scheme_options_usingBlock(range: NSRange, tagScheme: NSLinguisticTagScheme, opts: NSLinguisticTaggerOptions, block: MemorySegment): Unit {
    ...
    fun tagAtIndex_scheme_tokenRange_sentenceRange(charIndex: NSUInteger, scheme: NSLinguisticTagScheme, tokenRange: MemorySegment, sentenceRange: MemorySegment): NSLinguisticTag {
    ...
    fun tagsInRange_scheme_options_tokenRanges(range: NSRange, tagScheme: MemorySegment, opts: NSLinguisticTaggerOptions, tokenRanges: MemorySegment): MemorySegment {
    ...
    /** @return NSArray<NSString *> * */
    fun possibleTagsAtIndex_scheme_tokenRange_sentenceRange_scores(charIndex: NSUInteger, tagScheme: MemorySegment, tokenRange: MemorySegment, sentenceRange: MemorySegment, scores: MemorySegment): MemorySegment {
    ...
    fun dominantLanguage(): MemorySegment {
        val sel = ObjCRuntime.sel("dominantLanguage")
        return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel) as MemorySegment
    }
    
    /** Convenience overload — returns Kotlin [String] by converting the NSString via UTF8String. */
    fun dominantLanguageAsString(): String = ObjCRuntime.toJavaString(dominantLanguage())
