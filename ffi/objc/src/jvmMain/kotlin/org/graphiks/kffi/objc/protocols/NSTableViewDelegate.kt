...
interface NSTableViewDelegate : NSControlTextEditingDelegate {
    // @optional
    fun tableView_viewForTableColumn_row(tableView: MemorySegment, tableColumn: MemorySegment, row: NSInteger): MemorySegment =
        throw UnsupportedOperationException("Optional ObjC method 'tableView:viewForTableColumn:row:' not implemented")
    
    // @optional
    fun tableView_rowViewForRow(tableView: MemorySegment, row: NSInteger): MemorySegment =
        throw UnsupportedOperationException("Optional ObjC method 'tableView:rowViewForRow:' not implemented")
    
    // @optional
    fun tableView_didAddRowView_forRow(tableView: MemorySegment, rowView: MemorySegment, row: NSInteger): Unit =
        throw UnsupportedOperationException("Optional ObjC method 'tableView:didAddRowView:forRow:' not implemented")
    
    // @optional
    fun tableView_didRemoveRowView_forRow(tableView: MemorySegment, rowView: MemorySegment, row: NSInteger): Unit =
        throw UnsupportedOperationException("Optional ObjC method 'tableView:didRemoveRowView:forRow:' not implemented")
    
    // @optional
    fun tableView_willDisplayCell_forTableColumn_row(tableView: MemorySegment, cell: MemorySegment, tableColumn: MemorySegment, row: NSInteger): Unit =
        throw UnsupportedOperationException("Optional ObjC method 'tableView:willDisplayCell:forTableColumn:row:' not implemented")
    
    // @optional
    fun tableView_shouldEditTableColumn_row(tableView: MemorySegment, tableColumn: MemorySegment, row: NSInteger): BOOL =
        throw UnsupportedOperationException("Optional ObjC method 'tableView:shouldEditTableColumn:row:' not implemented")
    
    // @optional
    fun tableView_toolTipForCell_rect_tableColumn_row_mouseLocation(tableView: MemorySegment, cell: MemorySegment, rect: MemorySegment, tableColumn: MemorySegment, row: NSInteger, mouseLocation: NSPoint): MemorySegment =
    ...
    // @optional
    fun tableView_shouldShowCellExpansionForTableColumn_row(tableView: MemorySegment, tableColumn: MemorySegment, row: NSInteger): BOOL =
    ...
    // @optional
    fun tableView_shouldTrackCell_forTableColumn_row(tableView: MemorySegment, cell: MemorySegment, tableColumn: MemorySegment, row: NSInteger): BOOL =
        throw UnsupportedOperationException("Optional ObjC method 'tableView:shouldTrackCell:forTableColumn:row:' not implemented")
    
    // @optional
    fun tableView_dataCellForTableColumn_row(tableView: MemorySegment, tableColumn: MemorySegment, row: NSInteger): MemorySegment =
        throw UnsupportedOperationException("Optional ObjC method 'tableView:dataCellForTableColumn:row:' not implemented")
    
    // @optional
    fun selectionShouldChangeInTableView(tableView: MemorySegment): BOOL =
        throw UnsupportedOperationException("Optional ObjC method 'selectionShouldChangeInTableView:' not implemented")
    
    // @optional
    fun tableView_shouldSelectRow(tableView: MemorySegment, row: NSInteger): BOOL =
    ...
    // @optional
    fun tableView_shouldSelectTableColumn(tableView: MemorySegment, tableColumn: MemorySegment): BOOL =
    ...
    // @optional
    fun tableView_heightOfRow(tableView: MemorySegment, row: NSInteger): CGFloat =
        throw UnsupportedOperationException("Optional ObjC method 'tableView:heightOfRow:' not implemented")
    
    // @optional
    fun tableView_typeSelectStringForTableColumn_row(tableView: MemorySegment, tableColumn: MemorySegment, row: NSInteger): MemorySegment =
        throw UnsupportedOperationException("Optional ObjC method 'tableView:typeSelectStringForTableColumn:row:' not implemented")
    
    // @optional
    fun tableView_nextTypeSelectMatchFromRow_toRow_forString(tableView: MemorySegment, startRow: NSInteger, endRow: NSInteger, searchString: MemorySegment): NSInteger =
    ...
    // @optional
    fun tableView_shouldTypeSelectForEvent_withCurrentSearchString(tableView: MemorySegment, event: MemorySegment, searchString: MemorySegment): BOOL =
    ...
    // @optional
    fun tableView_isGroupRow(tableView: MemorySegment, row: NSInteger): BOOL =
        throw UnsupportedOperationException("Optional ObjC method 'tableView:isGroupRow:' not implemented")
    
    // @optional
    fun tableView_sizeToFitWidthOfColumn(tableView: MemorySegment, column: NSInteger): CGFloat =
        throw UnsupportedOperationException("Optional ObjC method 'tableView:sizeToFitWidthOfColumn:' not implemented")
    
    // @optional
    fun tableView_shouldReorderColumn_toColumn(tableView: MemorySegment, columnIndex: NSInteger, newColumnIndex: NSInteger): BOOL =
    ...
    // @optional
    fun tableView_rowActionsForRow_edge(tableView: MemorySegment, row: NSInteger, edge: NSTableRowActionEdge): MemorySegment =
        throw UnsupportedOperationException("Optional ObjC method 'tableView:rowActionsForRow:edge:' not implemented")
    
    // @optional
    fun tableView_userCanChangeVisibilityOfTableColumn(tableView: MemorySegment, column: MemorySegment): BOOL =
