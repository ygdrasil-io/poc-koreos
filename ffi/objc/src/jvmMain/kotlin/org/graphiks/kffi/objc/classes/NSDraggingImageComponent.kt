...
open class NSDraggingImageComponent(val ptr: MemorySegment) {
    companion object {
        ...
        fun draggingImageComponentWithKey(key: NSDraggingImageComponentKey): MemorySegment {
    ...
    fun initWithKey(key: NSDraggingImageComponentKey): MemorySegment {
