...
open class NSFormatter(val ptr: MemorySegment) {
    ...
    open fun stringForObjectValueAsString(obj: MemorySegment): String = ObjCRuntime.toJavaString(stringForObjectValue(obj))
    ...
    /** Convenience overload — returns Kotlin [String] by converting the NSString via UTF8String. */
    open fun editingStringForObjectValueAsString(obj: MemorySegment): String = ObjCRuntime.toJavaString(editingStringForObjectValue(obj))
    
    open fun getObjectValue_forString_errorDescription(obj: MemorySegment, string: MemorySegment, error: MemorySegment): BOOL {
    ...
    open fun getObjectValue_forString_errorDescription(obj: MemorySegment, string: String, error: String): BOOL = getObjectValue_forString_errorDescription(obj, ObjCRuntime.newNSString(Arena.global(), string), ObjCRuntime.newNSString(Arena.global(), error))
    
    open fun isPartialStringValid_newEditingString_errorDescription(partialString: MemorySegment, newString: MemorySegment, error: MemorySegment): BOOL {
    ...
    /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
    open fun isPartialStringValid_newEditingString_errorDescription(partialString: String, newString: String, error: String): BOOL = isPartialStringValid_newEditingString_errorDescription(ObjCRuntime.newNSString(Arena.global(), partialString), ObjCRuntime.newNSString(Arena.global(), newString), ObjCRuntime.newNSString(Arena.global(), error))
    
    open fun isPartialStringValid_proposedSelectedRange_originalString_originalSelectedRange_errorDescription(partialStringPtr: MemorySegment, proposedSelRangePtr: MemorySegment, origString: MemorySegment, origSelRange: NSRange, error: MemorySegment): BOOL {
