...
open class NSScriptCoercionHandler(val ptr: MemorySegment) {
    ...
    fun coerceValue_toClass(value: MemorySegment, toClass: Class): MemorySegment {
    ...
    fun registerCoercer_selector_toConvertFromClass_toClass(coercer: MemorySegment, selector: MemorySegment, fromClass: Class, toClass: Class): Unit {
