...
open class NSCalendar(val ptr: MemorySegment) {
    companion object {
        ...
        fun calendarWithIdentifier(calendarIdentifierConstant: NSCalendarIdentifier): MemorySegment {
    ...
    fun initWithCalendarIdentifier(ident: NSCalendarIdentifier): MemorySegment {
    ...
    fun minimumRangeOfUnit(unit: NSCalendarUnit): NSRange {
    ...
    fun maximumRangeOfUnit(unit: NSCalendarUnit): NSRange {
        val sel = ObjCRuntime.sel("maximumRangeOfUnit:")
        return ObjCRuntime.msgSendStret(MemoryLayout.structLayout(ValueLayout.JAVA_LONG.withName("location"), ValueLayout.JAVA_LONG.withName("length")).withName("_NSRange"), ptr, sel, unit) as NSRange
    }
    
    fun rangeOfUnit_inUnit_forDate(smaller: NSCalendarUnit, larger: NSCalendarUnit, date: MemorySegment): NSRange {
    ...
    fun ordinalityOfUnit_inUnit_forDate(smaller: NSCalendarUnit, larger: NSCalendarUnit, date: MemorySegment): NSUInteger {
    ...
    fun rangeOfUnit_startDate_interval_forDate(unit: NSCalendarUnit, datep: MemorySegment, tip: MemorySegment, date: MemorySegment): BOOL {
    ...
    fun dateFromComponents(comps: MemorySegment): MemorySegment {
        val sel = ObjCRuntime.sel("dateFromComponents:")
        return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, comps) as MemorySegment
    }
    
    fun components_fromDate(unitFlags: NSCalendarUnit, date: MemorySegment): MemorySegment {
    ...
    fun dateByAddingComponents_toDate_options(comps: MemorySegment, date: MemorySegment, opts: NSCalendarOptions): MemorySegment {
    ...
    fun components_fromDate_toDate_options(unitFlags: NSCalendarUnit, startingDate: MemorySegment, resultDate: MemorySegment, opts: NSCalendarOptions): MemorySegment {
    ...
    fun getEra_year_month_day_fromDate(eraValuePointer: MemorySegment, yearValuePointer: MemorySegment, monthValuePointer: MemorySegment, dayValuePointer: MemorySegment, date: MemorySegment): Unit {
    ...
    fun getEra_yearForWeekOfYear_weekOfYear_weekday_fromDate(eraValuePointer: MemorySegment, yearValuePointer: MemorySegment, weekValuePointer: MemorySegment, weekdayValuePointer: MemorySegment, date: MemorySegment): Unit {
    ...
    fun getHour_minute_second_nanosecond_fromDate(hourValuePointer: MemorySegment, minuteValuePointer: MemorySegment, secondValuePointer: MemorySegment, nanosecondValuePointer: MemorySegment, date: MemorySegment): Unit {
    ...
    fun component_fromDate(unit: NSCalendarUnit, date: MemorySegment): NSInteger {
    ...
    fun dateWithEra_year_month_day_hour_minute_second_nanosecond(eraValue: NSInteger, yearValue: NSInteger, monthValue: NSInteger, dayValue: NSInteger, hourValue: NSInteger, minuteValue: NSInteger, secondValue: NSInteger, nanosecondValue: NSInteger): MemorySegment {
    ...
    fun dateWithEra_yearForWeekOfYear_weekOfYear_weekday_hour_minute_second_nanosecond(eraValue: NSInteger, yearValue: NSInteger, weekValue: NSInteger, weekdayValue: NSInteger, hourValue: NSInteger, minuteValue: NSInteger, secondValue: NSInteger, nanosecondValue: NSInteger): MemorySegment {
    ...
    fun startOfDayForDate(date: MemorySegment): MemorySegment {
        val sel = ObjCRuntime.sel("startOfDayForDate:")
        return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, date) as MemorySegment
    }
    
    fun componentsInTimeZone_fromDate(timezone: MemorySegment, date: MemorySegment): MemorySegment {
    ...
    fun compareDate_toDate_toUnitGranularity(date1: MemorySegment, date2: MemorySegment, unit: NSCalendarUnit): NSComparisonResult {
    ...
    fun isDate_equalToDate_toUnitGranularity(date1: MemorySegment, date2: MemorySegment, unit: NSCalendarUnit): BOOL {
    ...
    fun isDate_inSameDayAsDate(date1: MemorySegment, date2: MemorySegment): BOOL {
    ...
    fun isDateInToday(date: MemorySegment): BOOL {
        val sel = ObjCRuntime.sel("isDateInToday:")
        return ObjCRuntime.msgSend(ValueLayout.JAVA_BOOLEAN, ptr, sel, date) as BOOL
    }
    
    fun isDateInYesterday(date: MemorySegment): BOOL {
        val sel = ObjCRuntime.sel("isDateInYesterday:")
        return ObjCRuntime.msgSend(ValueLayout.JAVA_BOOLEAN, ptr, sel, date) as BOOL
    }
    
    fun isDateInTomorrow(date: MemorySegment): BOOL {
        val sel = ObjCRuntime.sel("isDateInTomorrow:")
        return ObjCRuntime.msgSend(ValueLayout.JAVA_BOOLEAN, ptr, sel, date) as BOOL
    }
    
    fun isDateInWeekend(date: MemorySegment): BOOL {
        val sel = ObjCRuntime.sel("isDateInWeekend:")
        return ObjCRuntime.msgSend(ValueLayout.JAVA_BOOLEAN, ptr, sel, date) as BOOL
    }
    
    fun rangeOfWeekendStartDate_interval_containingDate(datep: MemorySegment, tip: MemorySegment, date: MemorySegment): BOOL {
    ...
    fun nextWeekendStartDate_interval_options_afterDate(datep: MemorySegment, tip: MemorySegment, options: NSCalendarOptions, date: MemorySegment): BOOL {
    ...
    fun components_fromDateComponents_toDateComponents_options(unitFlags: NSCalendarUnit, startingDateComp: MemorySegment, resultDateComp: MemorySegment, options: NSCalendarOptions): MemorySegment {
    ...
    fun dateByAddingUnit_value_toDate_options(unit: NSCalendarUnit, value: NSInteger, date: MemorySegment, options: NSCalendarOptions): MemorySegment {
    ...
    fun enumerateDatesStartingAfterDate_matchingComponents_options_usingBlock(start: MemorySegment, comps: MemorySegment, opts: NSCalendarOptions, block: MemorySegment): Unit {
    ...
    fun nextDateAfterDate_matchingComponents_options(date: MemorySegment, comps: MemorySegment, options: NSCalendarOptions): MemorySegment {
    ...
    fun nextDateAfterDate_matchingUnit_value_options(date: MemorySegment, unit: NSCalendarUnit, value: NSInteger, options: NSCalendarOptions): MemorySegment {
    ...
    fun nextDateAfterDate_matchingHour_minute_second_options(date: MemorySegment, hourValue: NSInteger, minuteValue: NSInteger, secondValue: NSInteger, options: NSCalendarOptions): MemorySegment {
    ...
    fun dateBySettingUnit_value_ofDate_options(unit: NSCalendarUnit, v: NSInteger, date: MemorySegment, opts: NSCalendarOptions): MemorySegment {
    ...
    fun dateBySettingHour_minute_second_ofDate_options(h: NSInteger, m: NSInteger, s: NSInteger, date: MemorySegment, opts: NSCalendarOptions): MemorySegment {
    ...
    fun date_matchesComponents(date: MemorySegment, components: MemorySegment): BOOL {
    ...
    fun calendarIdentifier(): NSCalendarIdentifier {
