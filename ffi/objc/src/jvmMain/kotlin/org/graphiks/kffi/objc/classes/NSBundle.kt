...
open class NSBundle(val ptr: MemorySegment) {
    companion object {
        ...
        open fun bundleWithPath(path: MemorySegment): MemorySegment {
        ...
        open fun bundleWithPath(path: String): MemorySegment = bundleWithPath(ObjCRuntime.newNSString(Arena.global(), path))
        
        open fun bundleWithURL(url: MemorySegment): MemorySegment {
            val sel = ObjCRuntime.sel("bundleWithURL:")
            return ObjCRuntime.msgSend(ValueLayout.ADDRESS, _class, sel, url) as MemorySegment
        }
        
        open fun bundleForClass(aClass: Class<*>): MemorySegment {
            val sel = ObjCRuntime.sel("bundleForClass:")
            return ObjCRuntime.msgSend(ValueLayout.ADDRESS, _class, sel, aClass) as MemorySegment
        }
        
        open fun bundleWithIdentifier(identifier: MemorySegment): MemorySegment {
        ...
        /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
        open fun bundleWithIdentifier(identifier: String): MemorySegment = bundleWithIdentifier(ObjCRuntime.newNSString(Arena.global(), identifier))
        
        open fun URLForResource_withExtension_subdirectory_inBundleWithURL(name: MemorySegment, ext: MemorySegment, subpath: MemorySegment, bundleURL: MemorySegment): MemorySegment {
        ...
        /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
        open fun URLForResource_withExtension_subdirectory_inBundleWithURL(name: String, ext: String, subpath: String, bundleURL: MemorySegment): MemorySegment = URLForResource_withExtension_subdirectory_inBundleWithURL(ObjCRuntime.newNSString(Arena.global(), name), ObjCRuntime.newNSString(Arena.global(), ext), ObjCRuntime.newNSString(Arena.global(), subpath), bundleURL)
        
        /** @return NSArray<NSURL *> * */
        open fun URLsForResourcesWithExtension_subdirectory_inBundleWithURL(ext: MemorySegment, subpath: MemorySegment, bundleURL: MemorySegment): MemorySegment {
        ...
        /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
        open fun URLsForResourcesWithExtension_subdirectory_inBundleWithURL(ext: String, subpath: String, bundleURL: MemorySegment): MemorySegment = URLsForResourcesWithExtension_subdirectory_inBundleWithURL(ObjCRuntime.newNSString(Arena.global(), ext), ObjCRuntime.newNSString(Arena.global(), subpath), bundleURL)
        
        open fun pathForResource_ofType_inDirectory(name: MemorySegment, ext: MemorySegment, bundlePath: MemorySegment): MemorySegment {
        ...
        open fun pathForResource_ofType_inDirectoryAsString(name: MemorySegment, ext: MemorySegment, bundlePath: MemorySegment): String = ObjCRuntime.toJavaString(pathForResource_ofType_inDirectory(name, ext, bundlePath))
        
        /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
        open fun pathForResource_ofType_inDirectory(name: String, ext: String, bundlePath: String): MemorySegment = pathForResource_ofType_inDirectory(ObjCRuntime.newNSString(Arena.global(), name), ObjCRuntime.newNSString(Arena.global(), ext), ObjCRuntime.newNSString(Arena.global(), bundlePath))
        
        /** Convenience overload — [String] parameters and [String] return type. */
        open fun pathForResource_ofType_inDirectoryAsString(name: String, ext: String, bundlePath: String): String = ObjCRuntime.toJavaString(pathForResource_ofType_inDirectory(ObjCRuntime.newNSString(Arena.global(), name), ObjCRuntime.newNSString(Arena.global(), ext), ObjCRuntime.newNSString(Arena.global(), bundlePath)))
        
        /** @return NSArray<NSString *> * */
        open fun pathsForResourcesOfType_inDirectory(ext: MemorySegment, bundlePath: MemorySegment): MemorySegment {
        ...
        /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
        open fun pathsForResourcesOfType_inDirectory(ext: String, bundlePath: String): MemorySegment = pathsForResourcesOfType_inDirectory(ObjCRuntime.newNSString(Arena.global(), ext), ObjCRuntime.newNSString(Arena.global(), bundlePath))
        
        /** @return NSArray<NSString *> * */
        open fun preferredLocalizationsFromArray(localizationsArray: MemorySegment): MemorySegment {
        ...
        /** @return NSArray<NSString *> * */
        open fun preferredLocalizationsFromArray_forPreferences(localizationsArray: MemorySegment, preferencesArray: MemorySegment): MemorySegment {
    ...
    /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
    open fun URLForAuxiliaryExecutable(executableName: String): MemorySegment = URLForAuxiliaryExecutable(ObjCRuntime.newNSString(Arena.global(), executableName))
    ...
    /** Convenience overload — returns Kotlin [String] by converting the NSString via UTF8String. */
    open fun pathForAuxiliaryExecutableAsString(executableName: MemorySegment): String = ObjCRuntime.toJavaString(pathForAuxiliaryExecutable(executableName))
    
    /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
    open fun pathForAuxiliaryExecutable(executableName: String): MemorySegment = pathForAuxiliaryExecutable(ObjCRuntime.newNSString(Arena.global(), executableName))
    
    /** Convenience overload — [String] parameters and [String] return type. */
    open fun pathForAuxiliaryExecutableAsString(executableName: String): String = ObjCRuntime.toJavaString(pathForAuxiliaryExecutable(ObjCRuntime.newNSString(Arena.global(), executableName)))
    ...
    /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
    open fun URLForResource_withExtension(name: String, ext: String): MemorySegment = URLForResource_withExtension(ObjCRuntime.newNSString(Arena.global(), name), ObjCRuntime.newNSString(Arena.global(), ext))
    ...
    /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
    open fun URLForResource_withExtension_subdirectory(name: String, ext: String, subpath: String): MemorySegment = URLForResource_withExtension_subdirectory(ObjCRuntime.newNSString(Arena.global(), name), ObjCRuntime.newNSString(Arena.global(), ext), ObjCRuntime.newNSString(Arena.global(), subpath))
    ...
    /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
    open fun URLsForResourcesWithExtension_subdirectory(ext: String, subpath: String): MemorySegment = URLsForResourcesWithExtension_subdirectory(ObjCRuntime.newNSString(Arena.global(), ext), ObjCRuntime.newNSString(Arena.global(), subpath))
    ...
    /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
    open fun URLsForResourcesWithExtension_subdirectory_localization(ext: String, subpath: String, localizationName: String): MemorySegment = URLsForResourcesWithExtension_subdirectory_localization(ObjCRuntime.newNSString(Arena.global(), ext), ObjCRuntime.newNSString(Arena.global(), subpath), ObjCRuntime.newNSString(Arena.global(), localizationName))
    ...
    /** Convenience overload — returns Kotlin [String] by converting the NSString via UTF8String. */
    open fun pathForResource_ofTypeAsString(name: MemorySegment, ext: MemorySegment): String = ObjCRuntime.toJavaString(pathForResource_ofType(name, ext))
    
    /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
    open fun pathForResource_ofType(name: String, ext: String): MemorySegment = pathForResource_ofType(ObjCRuntime.newNSString(Arena.global(), name), ObjCRuntime.newNSString(Arena.global(), ext))
    ...
    /** Convenience overload — returns Kotlin [String] by converting the NSString via UTF8String. */
    open fun pathForResource_ofType_inDirectory_forLocalizationAsString(name: MemorySegment, ext: MemorySegment, subpath: MemorySegment, localizationName: MemorySegment): String = ObjCRuntime.toJavaString(pathForResource_ofType_inDirectory_forLocalization(name, ext, subpath, localizationName))
    
    /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
    open fun pathForResource_ofType_inDirectory_forLocalization(name: String, ext: String, subpath: String, localizationName: String): MemorySegment = pathForResource_ofType_inDirectory_forLocalization(ObjCRuntime.newNSString(Arena.global(), name), ObjCRuntime.newNSString(Arena.global(), ext), ObjCRuntime.newNSString(Arena.global(), subpath), ObjCRuntime.newNSString(Arena.global(), localizationName))
    ...
    /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
    open fun pathsForResourcesOfType_inDirectory_forLocalization(ext: String, subpath: String, localizationName: String): MemorySegment = pathsForResourcesOfType_inDirectory_forLocalization(ObjCRuntime.newNSString(Arena.global(), ext), ObjCRuntime.newNSString(Arena.global(), subpath), ObjCRuntime.newNSString(Arena.global(), localizationName))
    ...
    /** Convenience overload — returns Kotlin [String] by converting the NSString via UTF8String. */
    open fun localizedStringForKey_value_tableAsString(key: MemorySegment, value: MemorySegment, tableName: MemorySegment): String = ObjCRuntime.toJavaString(localizedStringForKey_value_table(key, value, tableName))
    
    /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
    open fun localizedStringForKey_value_table(key: String, value: String, tableName: String): MemorySegment = localizedStringForKey_value_table(ObjCRuntime.newNSString(Arena.global(), key), ObjCRuntime.newNSString(Arena.global(), value), ObjCRuntime.newNSString(Arena.global(), tableName))
    
    /** Convenience overload — [String] parameters and [String] return type. */
    open fun localizedStringForKey_value_tableAsString(key: String, value: String, tableName: String): String = ObjCRuntime.toJavaString(localizedStringForKey_value_table(ObjCRuntime.newNSString(Arena.global(), key), ObjCRuntime.newNSString(Arena.global(), value), ObjCRuntime.newNSString(Arena.global(), tableName)))
    ...
    /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
    open fun localizedAttributedStringForKey_value_table(key: String, value: String, tableName: String): MemorySegment = localizedAttributedStringForKey_value_table(ObjCRuntime.newNSString(Arena.global(), key), ObjCRuntime.newNSString(Arena.global(), value), ObjCRuntime.newNSString(Arena.global(), tableName))
    ...
    /** Convenience overload — returns Kotlin [String] by converting the NSString via UTF8String. */
    open fun localizedStringForKey_value_table_localizationsAsString(key: MemorySegment, value: MemorySegment, tableName: MemorySegment, localizations: MemorySegment): String = ObjCRuntime.toJavaString(localizedStringForKey_value_table_localizations(key, value, tableName, localizations))
    
    /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
    open fun localizedStringForKey_value_table_localizations(key: String, value: String, tableName: String, localizations: MemorySegment): MemorySegment = localizedStringForKey_value_table_localizations(ObjCRuntime.newNSString(Arena.global(), key), ObjCRuntime.newNSString(Arena.global(), value), ObjCRuntime.newNSString(Arena.global(), tableName), localizations)
    
    /** Convenience overload — [String] parameters and [String] return type. */
    open fun localizedStringForKey_value_table_localizationsAsString(key: String, value: String, tableName: String, localizations: MemorySegment): String = ObjCRuntime.toJavaString(localizedStringForKey_value_table_localizations(ObjCRuntime.newNSString(Arena.global(), key), ObjCRuntime.newNSString(Arena.global(), value), ObjCRuntime.newNSString(Arena.global(), tableName), localizations))
    ...
    /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
    open fun objectForInfoDictionaryKey(key: String): MemorySegment = objectForInfoDictionaryKey(ObjCRuntime.newNSString(Arena.global(), key))
    
    open fun classNamed(className: MemorySegment): Class<*> {
