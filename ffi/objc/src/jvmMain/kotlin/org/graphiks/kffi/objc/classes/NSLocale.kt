 ...
 */
open class NSLocale(val ptr: MemorySegment) {
    companion object {
...
fun NSLocale.localizedStringForLocaleIdentifier(localeIdentifier: MemorySegment): MemorySegment {
    ...
    return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, localeIdentifier) as MemorySegment
}
...
fun NSLocale.localizedStringForLanguageCode(languageCode: MemorySegment): MemorySegment {
    ...
    return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, languageCode) as MemorySegment
}
...
fun NSLocale.localizedStringForCountryCode(countryCode: MemorySegment): MemorySegment {
    ...
    return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, countryCode) as MemorySegment
}
...
fun NSLocale.localizedStringForScriptCode(scriptCode: MemorySegment): MemorySegment {
    ...
    return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, scriptCode) as MemorySegment
}
...
fun NSLocale.localizedStringForVariantCode(variantCode: MemorySegment): MemorySegment {
    ...
    return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, variantCode) as MemorySegment
}
...
fun NSLocale.localizedStringForCalendarIdentifier(calendarIdentifier: MemorySegment): MemorySegment {
    ...
    return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, calendarIdentifier) as MemorySegment
}
...
fun NSLocale.localizedStringForCollationIdentifier(collationIdentifier: MemorySegment): MemorySegment {
    ...
    return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, collationIdentifier) as MemorySegment
}
...
fun NSLocale.localizedStringForCurrencyCode(currencyCode: MemorySegment): MemorySegment {
    ...
    return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, currencyCode) as MemorySegment
}
...
fun NSLocale.localizedStringForCollatorIdentifier(collatorIdentifier: MemorySegment): MemorySegment {
    ...
    return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, collatorIdentifier) as MemorySegment
}
