...
open class CIColor(val ptr: MemorySegment) {
    companion object {
        ...
        open fun colorWithCGColor(color: MemorySegment): MemorySegment {
        ...
        open fun colorWithRed_green_blue(red: CGFloat, green: CGFloat, blue: CGFloat): MemorySegment {
        ...
        open fun colorWithRed_green_blue_alpha_colorSpace(red: CGFloat, green: CGFloat, blue: CGFloat, alpha: CGFloat, colorSpace: MemorySegment): MemorySegment {
        ...
        open fun colorWithRed_green_blue_colorSpace(red: CGFloat, green: CGFloat, blue: CGFloat, colorSpace: MemorySegment): MemorySegment {
        ...
        open fun colorWithString(representation: MemorySegment): MemorySegment {
        ...
        open fun colorWithString(representation: String): MemorySegment = colorWithString(ObjCRuntime.newNSString(Arena.global(), representation))
    ...
    open fun initWithRed_green_blue_alpha(red: CGFloat, green: CGFloat, blue: CGFloat, alpha: CGFloat): MemorySegment {
    ...
    open fun initWithRed_green_blue(red: CGFloat, green: CGFloat, blue: CGFloat): MemorySegment {
    ...
    open fun initWithRed_green_blue_alpha_colorSpace(red: CGFloat, green: CGFloat, blue: CGFloat, alpha: CGFloat, colorSpace: MemorySegment): MemorySegment {
    ...
    open fun initWithRed_green_blue_colorSpace(red: CGFloat, green: CGFloat, blue: CGFloat, colorSpace: MemorySegment): MemorySegment {
    ...
    open fun numberOfComponents(): size_t {
    ...
    // @property red
    open fun red(): CGFloat {
        val sel = ObjCRuntime.sel("red")
        return ObjCRuntime.msgSend(ValueLayout.JAVA_DOUBLE, ptr, sel) as CGFloat
    }
    
    // @property green
    open fun green(): CGFloat {
        val sel = ObjCRuntime.sel("green")
        return ObjCRuntime.msgSend(ValueLayout.JAVA_DOUBLE, ptr, sel) as CGFloat
    }
    
    // @property blue
    open fun blue(): CGFloat {
