 ...
 */
interface NSTokenFieldCellDelegate : NSObject {
    // @optional
    fun tokenFieldCell_completionsForSubstring_indexOfToken_indexOfSelectedItem(tokenFieldCell: MemorySegment, substring: MemorySegment, tokenIndex: NSInteger, selectedIndex: MemorySegment): MemorySegment =
    ...
    // @optional
    fun tokenFieldCell_shouldAddObjects_atIndex(tokenFieldCell: MemorySegment, tokens: MemorySegment, index: NSUInteger): MemorySegment =
    ...
    // @optional
    fun tokenFieldCell_writeRepresentedObjects_toPasteboard(tokenFieldCell: MemorySegment, objects: MemorySegment, pboard: MemorySegment): BOOL =
    ...
    // @optional
    fun tokenFieldCell_hasMenuForRepresentedObject(tokenFieldCell: MemorySegment, representedObject: MemorySegment): BOOL =
