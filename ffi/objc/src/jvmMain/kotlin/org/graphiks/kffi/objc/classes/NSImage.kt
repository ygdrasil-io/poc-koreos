 ...
 * Superclass: NSObject
 */
open class NSImage(val ptr: MemorySegment) {
    companion object {
...
fun NSImage.initWithIconRef(iconRef: MemorySegment): MemorySegment {
    ...
    return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, iconRef) as MemorySegment
}
...
fun NSImage.bestRepresentationForDevice(deviceDescription: MemorySegment): MemorySegment {
    ...
    return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, deviceDescription) as MemorySegment
}
...
fun NSImage.lockFocusFlipped(flipped: BOOL): Unit {
    val sel = ObjCRuntime.sel("lockFocusFlipped:")
    ObjCRuntime.msgSend(null, ptr, sel, flipped)
}
...
fun NSImage.setFlipped(flag: BOOL): Unit {
    val sel = ObjCRuntime.sel("setFlipped:")
    ObjCRuntime.msgSend(null, ptr, sel, flag)
}

fun NSImage.isFlipped(): BOOL {
    val sel = ObjCRuntime.sel("isFlipped")
    return ObjCRuntime.msgSend(ValueLayout.JAVA_BOOLEAN, ptr, sel) as BOOL
}

fun NSImage.setScalesWhenResized(flag: BOOL): Unit {
    val sel = ObjCRuntime.sel("setScalesWhenResized:")
    ObjCRuntime.msgSend(null, ptr, sel, flag)
}

fun NSImage.scalesWhenResized(): BOOL {
    val sel = ObjCRuntime.sel("scalesWhenResized")
    return ObjCRuntime.msgSend(ValueLayout.JAVA_BOOLEAN, ptr, sel) as BOOL
}

fun NSImage.setDataRetained(flag: BOOL): Unit {
    val sel = ObjCRuntime.sel("setDataRetained:")
    ObjCRuntime.msgSend(null, ptr, sel, flag)
}

fun NSImage.isDataRetained(): BOOL {
    val sel = ObjCRuntime.sel("isDataRetained")
    return ObjCRuntime.msgSend(ValueLayout.JAVA_BOOLEAN, ptr, sel) as BOOL
}

fun NSImage.setCachedSeparately(flag: BOOL): Unit {
    val sel = ObjCRuntime.sel("setCachedSeparately:")
    ObjCRuntime.msgSend(null, ptr, sel, flag)
}

fun NSImage.isCachedSeparately(): BOOL {
    val sel = ObjCRuntime.sel("isCachedSeparately")
    return ObjCRuntime.msgSend(ValueLayout.JAVA_BOOLEAN, ptr, sel) as BOOL
}

fun NSImage.setCacheDepthMatchesImageDepth(flag: BOOL): Unit {
    val sel = ObjCRuntime.sel("setCacheDepthMatchesImageDepth:")
    ObjCRuntime.msgSend(null, ptr, sel, flag)
}

fun NSImage.cacheDepthMatchesImageDepth(): BOOL {
    val sel = ObjCRuntime.sel("cacheDepthMatchesImageDepth")
    return ObjCRuntime.msgSend(ValueLayout.JAVA_BOOLEAN, ptr, sel) as BOOL
}

fun NSImage.dissolveToPoint_fraction(point: NSPoint, fraction: CGFloat): Unit {
    val sel = ObjCRuntime.sel("dissolveToPoint:fraction:")
    ObjCRuntime.msgSend(null, ptr, sel, point, fraction)
}

fun NSImage.dissolveToPoint_fromRect_fraction(point: NSPoint, rect: NSRect, fraction: CGFloat): Unit {
    val sel = ObjCRuntime.sel("dissolveToPoint:fromRect:fraction:")
    ObjCRuntime.msgSend(null, ptr, sel, point, rect, fraction)
}
...
fun NSImage.compositeToPoint_operation(point: NSPoint, operation: NSCompositingOperation): Unit {
    ...
    ObjCRuntime.msgSend(null, ptr, sel, point, operation)
}
...
fun NSImage.compositeToPoint_fromRect_operation(point: NSPoint, rect: NSRect, operation: NSCompositingOperation): Unit {
    ...
    ObjCRuntime.msgSend(null, ptr, sel, point, rect, operation)
}

fun NSImage.compositeToPoint_operation_fraction(point: NSPoint, operation: NSCompositingOperation, fraction: CGFloat): Unit {
    val sel = ObjCRuntime.sel("compositeToPoint:operation:fraction:")
    ObjCRuntime.msgSend(null, ptr, sel, point, operation, fraction)
}

fun NSImage.compositeToPoint_fromRect_operation_fraction(point: NSPoint, rect: NSRect, operation: NSCompositingOperation, fraction: CGFloat): Unit {
    val sel = ObjCRuntime.sel("compositeToPoint:fromRect:operation:fraction:")
    ObjCRuntime.msgSend(null, ptr, sel, point, rect, operation, fraction)
}
...
fun NSImage.lockFocusOnRepresentation(imageRepresentation: MemorySegment): Unit {
    ...
    ObjCRuntime.msgSend(null, ptr, sel, imageRepresentation)
}
