...
/**
 * Kotlin/JVM wrapper for Objective-C class: NSPathControlItem
 * Superclass: NSObject
 */
open class NSPathControlItem(val ptr: MemorySegment) {
    companion object {
        private val _class: MemorySegment by lazy { ObjCRuntime.getClass("NSPathControlItem") }
