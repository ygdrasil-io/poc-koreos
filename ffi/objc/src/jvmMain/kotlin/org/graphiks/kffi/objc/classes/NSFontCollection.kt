...
open class NSFontCollection(val ptr: MemorySegment) {
    companion object {
        ...
        fun showFontCollection_withName_visibility_error(collection: MemorySegment, name: NSFontCollectionName, visibility: NSFontCollectionVisibility, error: MemorySegment): BOOL {
        ...
        fun hideFontCollectionWithName_visibility_error(name: NSFontCollectionName, visibility: NSFontCollectionVisibility, error: MemorySegment): BOOL {
        ...
        fun renameFontCollectionWithName_visibility_toName_error(oldName: NSFontCollectionName, visibility: NSFontCollectionVisibility, newName: NSFontCollectionName, outError: MemorySegment): BOOL {
    ...
    fun matchingDescriptorsWithOptions(options: MemorySegment): MemorySegment {
    ...
    /** @return NSArray<NSFontDescriptor *> * */
    fun matchingDescriptorsForFamily(family: MemorySegment): MemorySegment {
    ...
    /** @return NSArray<NSFontDescriptor *> * */
    fun matchingDescriptorsForFamily_options(family: MemorySegment, options: MemorySegment): MemorySegment {
    ...
    /** @return NSArray<NSFontDescriptor *> * */
    fun matchingDescriptors(): MemorySegment {
