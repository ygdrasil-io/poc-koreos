...
open class NSAccessibilityElement(val ptr: MemorySegment) {
    companion object {
        ...
        fun accessibilityElementWithRole_frame_label_parent(role: NSAccessibilityRole, frame: NSRect, label: MemorySegment, parent: MemorySegment): MemorySegment {
        ...
        fun accessibilityElementWithRole_frame_label_parent(role: NSAccessibilityRole, frame: NSRect, label: String, parent: MemorySegment): MemorySegment = accessibilityElementWithRole_frame_label_parent(role, frame, ObjCRuntime.newNSString(Arena.global(), label), parent)
        
    }
    
    fun accessibilityAddChildElement(childElement: MemorySegment): Unit {
    ...
    fun accessibilityFrameInParentSpace(): NSRect {
    ...
    fun setAccessibilityFrameInParentSpace(value: NSRect) {
