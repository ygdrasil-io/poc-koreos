...
open class NSMenu(val ptr: MemorySegment) {
    ...
    fun initWithTitle(title: MemorySegment): MemorySegment {
    ...
    fun popUpMenuPositioningItem_atLocation_inView(item: MemorySegment, location: NSPoint, view: MemorySegment): BOOL {
    ...
    fun insertItem_atIndex(newItem: MemorySegment, index: NSInteger): Unit {
        val sel = ObjCRuntime.sel("insertItem:atIndex:")
        ObjCRuntime.msgSend(null, ptr, sel, newItem, index)
    }
    
    fun addItem(newItem: MemorySegment): Unit {
        val sel = ObjCRuntime.sel("addItem:")
        ObjCRuntime.msgSend(null, ptr, sel, newItem)
    }
    
    fun insertItemWithTitle_action_keyEquivalent_atIndex(string: MemorySegment, selector: MemorySegment, charCode: MemorySegment, index: NSInteger): MemorySegment {
    ...
    /** Convenience overload — accepts Kotlin [String] for NSString parameters. */
    fun insertItemWithTitle_action_keyEquivalent_atIndex(string: String, selector: MemorySegment, charCode: String, index: NSInteger): MemorySegment = insertItemWithTitle_action_keyEquivalent_atIndex(ObjCRuntime.newNSString(Arena.global(), string), selector, ObjCRuntime.newNSString(Arena.global(), charCode), index)
    
    fun addItemWithTitle_action_keyEquivalent(string: MemorySegment, selector: MemorySegment, charCode: MemorySegment): MemorySegment {
    ...
    fun removeItem(item: MemorySegment): Unit {
        val sel = ObjCRuntime.sel("removeItem:")
        ObjCRuntime.msgSend(null, ptr, sel, item)
    }
    
    fun setSubmenu_forItem(menu: MemorySegment, item: MemorySegment): Unit {
    ...
    fun indexOfItemWithRepresentedObject(`object`: MemorySegment): NSInteger {
    ...
    fun indexOfItemWithSubmenu(submenu: MemorySegment): NSInteger {
    ...
    fun itemWithTag(tag: NSInteger): MemorySegment {
    ...
    fun itemChanged(item: MemorySegment): Unit {
        val sel = ObjCRuntime.sel("itemChanged:")
        ObjCRuntime.msgSend(null, ptr, sel, item)
    }
    
    fun performActionForItemAtIndex(index: NSInteger): Unit {
        val sel = ObjCRuntime.sel("performActionForItemAtIndex:")
        ObjCRuntime.msgSend(null, ptr, sel, index)
    }
    
    fun cancelTracking(): Unit {
        val sel = ObjCRuntime.sel("cancelTracking")
        ObjCRuntime.msgSend(null, ptr, sel)
    }
    
    fun cancelTrackingWithoutAnimation(): Unit {
    ...
    // @property supermenu
    fun supermenu(): MemorySegment {
        val sel = ObjCRuntime.sel("supermenu")
        return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel) as MemorySegment
    }
    fun setSupermenu(value: MemorySegment) {
    ...
    fun setItemArray(value: MemorySegment) {
