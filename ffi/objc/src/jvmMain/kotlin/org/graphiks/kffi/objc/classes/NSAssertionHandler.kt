...
open class NSAssertionHandler(val ptr: MemorySegment) {
    ...
    open fun handleFailureInMethod_object_file_lineNumber_description(selector: MemorySegment, `object`: MemorySegment, fileName: MemorySegment, line: NSInteger, format: MemorySegment): Unit {
