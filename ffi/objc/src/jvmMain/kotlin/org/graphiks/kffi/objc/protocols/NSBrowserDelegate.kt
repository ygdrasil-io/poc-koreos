...
interface NSBrowserDelegate : NSObject {
    // @optional
    fun browser_numberOfRowsInColumn(sender: MemorySegment, column: NSInteger): NSInteger =
        throw UnsupportedOperationException("Optional ObjC method 'browser:numberOfRowsInColumn:' not implemented")
    
    // @optional
    fun browser_createRowsForColumn_inMatrix(sender: MemorySegment, column: NSInteger, matrix: MemorySegment): Unit =
        throw UnsupportedOperationException("Optional ObjC method 'browser:createRowsForColumn:inMatrix:' not implemented")
    
    // @optional
    fun browser_numberOfChildrenOfItem(browser: MemorySegment, item: MemorySegment): NSInteger =
        throw UnsupportedOperationException("Optional ObjC method 'browser:numberOfChildrenOfItem:' not implemented")
    
    // @optional
    fun browser_child_ofItem(browser: MemorySegment, index: NSInteger, item: MemorySegment): MemorySegment =
        throw UnsupportedOperationException("Optional ObjC method 'browser:child:ofItem:' not implemented")
    
    // @optional
    fun browser_isLeafItem(browser: MemorySegment, item: MemorySegment): BOOL =
    ...
    // @optional
    fun browser_heightOfRow_inColumn(browser: MemorySegment, row: NSInteger, columnIndex: NSInteger): CGFloat =
    ...
    // @optional
    fun browser_shouldEditItem(browser: MemorySegment, item: MemorySegment): BOOL =
        throw UnsupportedOperationException("Optional ObjC method 'browser:shouldEditItem:' not implemented")
    
    // @optional
    fun browser_willDisplayCell_atRow_column(sender: MemorySegment, cell: MemorySegment, row: NSInteger, column: NSInteger): Unit =
        throw UnsupportedOperationException("Optional ObjC method 'browser:willDisplayCell:atRow:column:' not implemented")
    
    // @optional
    fun browser_titleOfColumn(sender: MemorySegment, column: NSInteger): MemorySegment =
        throw UnsupportedOperationException("Optional ObjC method 'browser:titleOfColumn:' not implemented")
    
    // @optional
    fun browser_selectCellWithString_inColumn(sender: MemorySegment, title: MemorySegment, column: NSInteger): BOOL =
        throw UnsupportedOperationException("Optional ObjC method 'browser:selectCellWithString:inColumn:' not implemented")
    
    // @optional
    fun browser_selectRow_inColumn(sender: MemorySegment, row: NSInteger, column: NSInteger): BOOL =
        throw UnsupportedOperationException("Optional ObjC method 'browser:selectRow:inColumn:' not implemented")
    
    // @optional
    fun browser_isColumnValid(sender: MemorySegment, column: NSInteger): BOOL =
    ...
    // @optional
    fun browser_shouldSizeColumn_forUserResize_toWidth(browser: MemorySegment, columnIndex: NSInteger, forUserResize: BOOL, suggestedWidth: CGFloat): CGFloat =
        throw UnsupportedOperationException("Optional ObjC method 'browser:shouldSizeColumn:forUserResize:toWidth:' not implemented")
    
    // @optional
    fun browser_sizeToFitWidthOfColumn(browser: MemorySegment, columnIndex: NSInteger): CGFloat =
    ...
    // @optional
    fun browser_shouldShowCellExpansionForRow_column(browser: MemorySegment, row: NSInteger, column: NSInteger): BOOL =
        throw UnsupportedOperationException("Optional ObjC method 'browser:shouldShowCellExpansionForRow:column:' not implemented")
    
    // @optional
    fun browser_writeRowsWithIndexes_inColumn_toPasteboard(browser: MemorySegment, rowIndexes: MemorySegment, column: NSInteger, pasteboard: MemorySegment): BOOL =
    ...
    // @optional
    fun browser_namesOfPromisedFilesDroppedAtDestination_forDraggedRowsWithIndexes_inColumn(browser: MemorySegment, dropDestination: MemorySegment, rowIndexes: MemorySegment, column: NSInteger): MemorySegment =
    ...
    // @optional
    fun browser_canDragRowsWithIndexes_inColumn_withEvent(browser: MemorySegment, rowIndexes: MemorySegment, column: NSInteger, event: MemorySegment): BOOL =
    ...
    // @optional
    fun browser_draggingImageForRowsWithIndexes_inColumn_withEvent_offset(browser: MemorySegment, rowIndexes: MemorySegment, column: NSInteger, event: MemorySegment, dragImageOffset: MemorySegment): MemorySegment =
    ...
    // @optional
    fun browser_acceptDrop_atRow_column_dropOperation(browser: MemorySegment, info: MemorySegment, row: NSInteger, column: NSInteger, dropOperation: NSBrowserDropOperation): BOOL =
        throw UnsupportedOperationException("Optional ObjC method 'browser:acceptDrop:atRow:column:dropOperation:' not implemented")
    
    // @optional
    fun browser_typeSelectStringForRow_inColumn(browser: MemorySegment, row: NSInteger, column: NSInteger): MemorySegment =
        throw UnsupportedOperationException("Optional ObjC method 'browser:typeSelectStringForRow:inColumn:' not implemented")
    
    // @optional
    fun browser_shouldTypeSelectForEvent_withCurrentSearchString(browser: MemorySegment, event: MemorySegment, searchString: MemorySegment): BOOL =
    ...
    // @optional
    fun browser_nextTypeSelectMatchFromRow_toRow_inColumn_forString(browser: MemorySegment, startRow: NSInteger, endRow: NSInteger, column: NSInteger, searchString: MemorySegment): NSInteger =
    ...
    // @optional
    fun browser_didChangeLastColumn_toColumn(browser: MemorySegment, oldLastColumn: NSInteger, column: NSInteger): Unit =
        throw UnsupportedOperationException("Optional ObjC method 'browser:didChangeLastColumn:toColumn:' not implemented")
    
    // @optional
    fun browser_selectionIndexesForProposedSelection_inColumn(browser: MemorySegment, proposedSelectionIndexes: MemorySegment, column: NSInteger): MemorySegment =
