 ...
 */
interface NSOpenSavePanelDelegate : NSObject {
    // @optional
    fun panel_shouldEnableURL(sender: MemorySegment, url: MemorySegment): BOOL =
        throw UnsupportedOperationException("Optional ObjC method 'panel:shouldEnableURL:' not implemented")
    
    // @optional
    fun panel_validateURL_error(sender: MemorySegment, url: MemorySegment, outError: MemorySegment): BOOL =
    ...
    // @optional
    fun panel_userEnteredFilename_confirmed(sender: MemorySegment, filename: MemorySegment, okFlag: BOOL): MemorySegment =
        throw UnsupportedOperationException("Optional ObjC method 'panel:userEnteredFilename:confirmed:' not implemented")
    
    // @optional
    fun panel_willExpand(sender: MemorySegment, expanding: BOOL): Unit =
