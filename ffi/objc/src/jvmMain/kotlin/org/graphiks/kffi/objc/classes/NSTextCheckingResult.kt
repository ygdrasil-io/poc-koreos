 ...
 */
open class NSTextCheckingResult(val ptr: MemorySegment) {
    companion object {
...
fun NSTextCheckingResult.rangeAtIndex(idx: NSUInteger): NSRange {
    val sel = ObjCRuntime.sel("rangeAtIndex:")
    return ObjCRuntime.msgSend(MemoryLayout.structLayout(ValueLayout.JAVA_LONG.withName("location"), ValueLayout.JAVA_LONG.withName("length")).withName("_NSRange"), ptr, sel, idx) as NSRange
}

fun NSTextCheckingResult.rangeWithName(name: MemorySegment): NSRange {
    val sel = ObjCRuntime.sel("rangeWithName:")
    return ObjCRuntime.msgSend(MemoryLayout.structLayout(ValueLayout.JAVA_LONG.withName("location"), ValueLayout.JAVA_LONG.withName("length")).withName("_NSRange"), ptr, sel, name) as NSRange
}

fun NSTextCheckingResult.resultByAdjustingRangesWithOffset(offset: NSInteger): MemorySegment {
    val sel = ObjCRuntime.sel("resultByAdjustingRangesWithOffset:")
    return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, offset) as MemorySegment
}
