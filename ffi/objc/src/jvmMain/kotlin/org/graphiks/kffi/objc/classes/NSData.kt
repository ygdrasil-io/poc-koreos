 ...
 */
open class NSData(val ptr: MemorySegment) {
    companion object {
...
fun NSData.getBytes_length(buffer: MemorySegment, length: NSUInteger): Unit {
    val sel = ObjCRuntime.sel("getBytes:length:")
    ObjCRuntime.msgSend(null, ptr, sel, buffer, length)
}
...
fun NSData.isEqualToData(other: MemorySegment): BOOL {
...
fun NSData.writeToFile_atomically(path: MemorySegment, useAuxiliaryFile: BOOL): BOOL {
...
fun NSData.writeToURL_atomically(url: MemorySegment, atomically: BOOL): BOOL {
...
fun NSData.writeToFile_options_error(path: MemorySegment, writeOptionsMask: NSDataWritingOptions, errorPtr: MemorySegment): BOOL {
    val sel = ObjCRuntime.sel("writeToFile:options:error:")
    return ObjCRuntime.msgSend(ValueLayout.JAVA_BOOLEAN, ptr, sel, path, writeOptionsMask, errorPtr) as BOOL
}

fun NSData.writeToURL_options_error(url: MemorySegment, writeOptionsMask: NSDataWritingOptions, errorPtr: MemorySegment): BOOL {
    val sel = ObjCRuntime.sel("writeToURL:options:error:")
    return ObjCRuntime.msgSend(ValueLayout.JAVA_BOOLEAN, ptr, sel, url, writeOptionsMask, errorPtr) as BOOL
}
...
fun NSData.rangeOfData_options_range(dataToFind: MemorySegment, mask: NSDataSearchOptions, searchRange: NSRange): NSRange {
    ...
    return ObjCRuntime.msgSend(MemoryLayout.structLayout(ValueLayout.JAVA_LONG.withName("location"), ValueLayout.JAVA_LONG.withName("length")).withName("_NSRange"), ptr, sel, dataToFind, mask, searchRange) as NSRange
}
...
fun NSData.initWithBytesNoCopy_length(bytes: MemorySegment, length: NSUInteger): MemorySegment {
    val sel = ObjCRuntime.sel("initWithBytesNoCopy:length:")
    return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, bytes, length) as MemorySegment
}

fun NSData.initWithBytesNoCopy_length_freeWhenDone(bytes: MemorySegment, length: NSUInteger, b: BOOL): MemorySegment {
    val sel = ObjCRuntime.sel("initWithBytesNoCopy:length:freeWhenDone:")
    return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, bytes, length, b) as MemorySegment
}

fun NSData.initWithBytesNoCopy_length_deallocator(bytes: MemorySegment, length: NSUInteger, deallocator: MemorySegment): MemorySegment {
    val sel = ObjCRuntime.sel("initWithBytesNoCopy:length:deallocator:")
    return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, bytes, length, deallocator) as MemorySegment
}
...
fun NSData.initWithContentsOfFile_options_error(path: MemorySegment, readOptionsMask: NSDataReadingOptions, errorPtr: MemorySegment): MemorySegment {
    ...
    return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, path, readOptionsMask, errorPtr) as MemorySegment
}
...
fun NSData.initWithContentsOfURL_options_error(url: MemorySegment, readOptionsMask: NSDataReadingOptions, errorPtr: MemorySegment): MemorySegment {
    ...
    return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, url, readOptionsMask, errorPtr) as MemorySegment
}
...
fun NSData.initWithBase64EncodedString_options(base64String: MemorySegment, options: NSDataBase64DecodingOptions): MemorySegment {
    ...
    return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, base64String, options) as MemorySegment
}
...
fun NSData.initWithBase64EncodedData_options(base64Data: MemorySegment, options: NSDataBase64DecodingOptions): MemorySegment {
    ...
    return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, base64Data, options) as MemorySegment
}
...
fun NSData.decompressedDataUsingAlgorithm_error(algorithm: NSDataCompressionAlgorithm, error: MemorySegment): MemorySegment {
    ...
    return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, algorithm, error) as MemorySegment
}
...
fun NSData.initWithBase64Encoding(base64String: MemorySegment): MemorySegment {
    ...
    return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel, base64String) as MemorySegment
}
