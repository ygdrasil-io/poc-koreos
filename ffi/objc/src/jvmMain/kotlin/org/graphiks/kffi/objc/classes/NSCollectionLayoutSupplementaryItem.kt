 ...
 * Protocols: NSCopying
 */
open class NSCollectionLayoutSupplementaryItem(ptr: MemorySegment) : NSCollectionLayoutItem(ptr) {
    companion object {
    ...
    fun containerAnchor(): MemorySegment {
        val sel = ObjCRuntime.sel("containerAnchor")
        return ObjCRuntime.msgSend(ValueLayout.ADDRESS, ptr, sel) as MemorySegment
    }
    
    // @property itemAnchor
    fun itemAnchor(): MemorySegment {
