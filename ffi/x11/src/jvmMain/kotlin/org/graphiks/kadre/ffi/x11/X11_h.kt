...
val libXext: SymbolLookup? by lazy {
    try {
 ...
 */
val xOpenDisplay: MethodHandle? by lazy {
    libX11.downcall(
        "XOpenDisplay",
 ...
 */
val xCloseDisplay: MethodHandle? by lazy {
    libX11.downcall(
        "XCloseDisplay",
        FunctionDescriptor.of(
 ...
 * causes `BadWindow`.
 */
val xRootWindow: MethodHandle? by lazy {
    libX11.downcall(
        "XRootWindow",
        FunctionDescriptor.of(
...
val xCreateSimpleWindow: MethodHandle? by lazy {
    libX11.downcall(
        "XCreateSimpleWindow",
        FunctionDescriptor.of(
 ...
 */
val xSelectInput: MethodHandle? by lazy {
    libX11.downcall(
        "XSelectInput",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,   // int return
 ...
 */
val xQueryKeymap: MethodHandle? by lazy {
    libX11.downcall(
        "XQueryKeymap",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,   // int return
 ...
 */
val xDestroyWindow: MethodHandle? by lazy {
    libX11.downcall(
        "XDestroyWindow",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,   // int return
 ...
 */
val xFlush: MethodHandle? by lazy {
    libX11.downcall(
        "XFlush",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,   // int return
 ...
 */
val xPending: MethodHandle? by lazy {
    libX11.downcall(
        "XPending",
        FunctionDescriptor.of(
 ...
 */
val xNextEvent: MethodHandle? by lazy {
    libX11.downcall(
        "XNextEvent",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,   // int return
 ...
 */
val xStoreName: MethodHandle? by lazy {
    libX11.downcall(
        "XStoreName",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,   // int return
 ...
 */
val xInternAtom: MethodHandle? by lazy {
    libX11.downcall(
        "XInternAtom",
        FunctionDescriptor.of(
 ...
 * (WM_DELETE_WINDOW).
 */
val xSetWMProtocols: MethodHandle? by lazy {
    libX11.downcall(
        "XSetWMProtocols",
        FunctionDescriptor.of(
 ...
 */
val xMapWindow: MethodHandle? by lazy {
    libX11.downcall(
        "XMapWindow",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,   // int return
 ...
 */
val xRaiseWindow: MethodHandle? by lazy {
    libX11.downcall(
        "XRaiseWindow",
        FunctionDescriptor.of(
 ...
 */
val xSendEvent: MethodHandle? by lazy {
    libX11.downcall(
        "XSendEvent",
        FunctionDescriptor.of(
 ...
 */
val xResizeWindow: MethodHandle? by lazy {
    libX11.downcall(
        "XResizeWindow",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,   // int return
 ...
 */
val xMoveWindow: MethodHandle? by lazy {
    libX11.downcall(
        "XMoveWindow",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,   // int return
 ...
 */
val xIconifyWindow: MethodHandle? by lazy {
    libX11.downcall(
        "XIconifyWindow",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,   // Status
 ...
 * _MOTIF_WM_HINTS, etc.
 */
val xChangeProperty: MethodHandle? by lazy {
    libX11.downcall(
        "XChangeProperty",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,   // int return
 ...
 */
val xGetWindowProperty: MethodHandle? by lazy {
    libX11.downcall(
        "XGetWindowProperty",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,
 ...
 * int XFree(void *data);
 */
val xFree: MethodHandle? by lazy {
    libX11.downcall(
        "XFree",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,
 ...
 */
val xGetGeometry: MethodHandle? by lazy {
    libX11.downcall(
        "XGetGeometry",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,   // Status
 ...
 *     Window *child_return);
 */
val xTranslateCoordinates: MethodHandle? by lazy {
    libX11.downcall(
        "XTranslateCoordinates",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,
 ...
 */
val xUnmapWindow: MethodHandle? by lazy {
    libX11.downcall(
        "XUnmapWindow",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,   // int return
 ...
 */
val xResourceManagerString: MethodHandle? by lazy {
    libX11.downcall(
        "XResourceManagerString",
        FunctionDescriptor.of(
 ...
 */
val xCreateFontCursor: MethodHandle? by lazy {
    libX11.downcall(
        "XCreateFontCursor",
        FunctionDescriptor.of(
 ...
 */
val xDefineCursor: MethodHandle? by lazy {
    libX11.downcall(
        "XDefineCursor",
        FunctionDescriptor.of(
 ...
 */
val xUndefineCursor: MethodHandle? by lazy {
    libX11.downcall(
        "XUndefineCursor",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,   // int
 ...
 */
val xFreeCursor: MethodHandle? by lazy {
    libX11.downcall(
        "XFreeCursor",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,
 ...
 *     unsigned int width, unsigned int height);
 */
val xCreateBitmapFromData: MethodHandle? by lazy {
    libX11.downcall(
 ...
 */
val xCreatePixmapCursor: MethodHandle? by lazy {
    libX11.downcall(
        "XCreatePixmapCursor",
        FunctionDescriptor.of(
 ...
 */
val xFreePixmap: MethodHandle? by lazy {
    libX11.downcall(
        "XFreePixmap",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,
 ...
 */
val xGrabPointer: MethodHandle? by lazy {
    libX11.downcall(
        "XGrabPointer",
        FunctionDescriptor.of(
 ...
 */
val xUngrabPointer: MethodHandle? by lazy {
    libX11.downcall(
        "XUngrabPointer",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,   // int
 ...
 */
val xQueryPointer: MethodHandle? by lazy {
    libX11.downcall(
        "XQueryPointer",
        FunctionDescriptor.of(
 ...
 */
val xWarpPointer: MethodHandle? by lazy {
    libX11.downcall(
        "XWarpPointer",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,   // int
 ...
 */
val xGetWMHints: MethodHandle? by lazy {
    libX11.downcall(
        "XGetWMHints",
        FunctionDescriptor.of(
 ...
 */
val xAllocWMHints: MethodHandle? by lazy {
    libX11.downcall(
        "XAllocWMHints",
 ...
 */
val xSetWMHints: MethodHandle? by lazy {
    libX11.downcall(
        "XSetWMHints",
...
const val XC_left_ptr: Int          = 68   // default arrow
const val XC_hand2: Int             = 60   // pointer / hand
const val XC_xterm: Int             = 152  // text I-beam
const val XC_crosshair: Int         = 34   // crosshair
const val XC_fleur: Int             = 52   // move (all-direction)
const val XC_watch: Int             = 150  // wait / busy
const val XC_X_cursor: Int          = 0    // not-allowed (X shape)
const val XC_hand1: Int             = 58   // grab open
const val XC_top_side: Int          = 138  // resize north
const val XC_bottom_side: Int       = 16   // resize south
const val XC_right_side: Int        = 96   // resize east
const val XC_left_side: Int         = 70   // resize west
const val XC_top_right_corner: Int  = 136  // resize NE
const val XC_top_left_corner: Int   = 134  // resize NW
const val XC_bottom_right_corner: Int = 14 // resize SE
const val XC_bottom_left_corner: Int = 12  // resize SW
const val XC_question_arrow: Int     = 30   // help
const val XC_plus: Int              = 58   // cell / plus (same shape as hand1)
const val XC_sb_h_double_arrow: Int = 108  // EW resize
const val XC_sb_v_double_arrow: Int = 116  // NS resize

// ── XIM (X Input Method) constants (X11/Xlib.h, X11/XIM.h) ────────────────

// XIM styles
const val XIMPreeditArea: Int = 0x0001
const val XIMPreeditCallbacks: Int = 0x0004
const val XIMPreeditPosition: Int = 0x0008
const val XIMPreeditNothing: Int = 0x0010
const val XIMStatusNothing: Int = 0x0100

// XN* attribute names (used as C strings in XIM varargs)
val XNInputStyle: String = "inputStyle"
val XNClientWindow: String = "clientWindow"
val XNFocusWindow: String = "focusWindow"
val XNPreeditAttributes: String = "preeditAttributes"
val XNArea: String = "area"
val XNAreaNeeded: String = "areaNeeded"
val XNSpotLocation: String = "spotLocation"
val XNPreeditStartCallback: String = "preeditStartCallback"
val XNPreeditDrawCallback: String = "preeditDrawCallback"
val XNPreeditDoneCallback: String = "preeditDoneCallback"
val XNCommitStringCallback: String = "commitStringCallback"
 ...
 */
val xOpenIM: MethodHandle? by lazy {
    libX11.downcall(
        "XOpenIM",
        FunctionDescriptor.of(
 ...
 */
val xCloseIM: MethodHandle? by lazy {
    libX11.downcall(
        "XCloseIM",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,  // Status
 ...
 */
val xDestroyIC: MethodHandle? by lazy {
    libX11.downcall(
        "XDestroyIC",
        FunctionDescriptor.ofVoid(
 ...
 */
val xConvertSelection: MethodHandle? by lazy {
    libX11.downcall(
        "XConvertSelection",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,    // Status
 ...
 */
val xSetICFocus: MethodHandle? by lazy {
    libX11.downcall(
        "XSetICFocus",
        FunctionDescriptor.ofVoid(
            ValueLayout.ADDRESS,  // XIC
 ...
 */
val xUnsetICFocus: MethodHandle? by lazy {
    libX11.downcall(
        "XUnsetICFocus",
        FunctionDescriptor.ofVoid(
            ValueLayout.ADDRESS,  // XIC
 ...
 */
val xFilterEvent: MethodHandle? by lazy {
    libX11.downcall(
        "XFilterEvent",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT,   // Bool return
