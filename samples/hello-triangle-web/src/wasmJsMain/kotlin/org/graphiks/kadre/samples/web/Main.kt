/**
 * Sample hello-triangle-web — wasmJs entry point.
 *
...
/** `window.devicePixelRatio` — not exposed on the wasmJs `Window`, read via JS interop. */
...
/**
 * Handler for the hello-triangle-web sample (wasmJs).
 *
...
/**
 * Entry point of the hello-triangle-web sample (wasmJs).
 */
fun main() {
