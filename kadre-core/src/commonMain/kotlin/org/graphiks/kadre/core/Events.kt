...
fun KeyCode.defaultLogicalKey(): LogicalKey = when (this) {
    ...
    KeyCode.Convert -> LogicalKey.Named(NamedKey.Convert)
    KeyCode.KanaMode -> LogicalKey.Named(NamedKey.KanaMode)
    KeyCode.NonConvert -> LogicalKey.Named(NamedKey.NonConvert)
    ...
    KeyCode.Hiragana -> LogicalKey.Named(NamedKey.Hiragana)
    KeyCode.Katakana -> LogicalKey.Named(NamedKey.Katakana)
    ...
    KeyCode.Hyper -> LogicalKey.Named(NamedKey.Hyper)
    KeyCode.NumLock -> LogicalKey.Named(NamedKey.NumLock)
    KeyCode.ShiftLeft, KeyCode.ShiftRight -> LogicalKey.Named(NamedKey.Shift)
    KeyCode.Super -> LogicalKey.Named(NamedKey.Super)
    KeyCode.Again -> LogicalKey.Named(NamedKey.Again)
    KeyCode.Copy -> LogicalKey.Named(NamedKey.Copy)
    KeyCode.Cut -> LogicalKey.Named(NamedKey.Cut)
    KeyCode.Eject -> LogicalKey.Named(NamedKey.Eject)
    KeyCode.Find -> LogicalKey.Named(NamedKey.Find)
    KeyCode.Open -> LogicalKey.Named(NamedKey.Open)
    KeyCode.Paste -> LogicalKey.Named(NamedKey.Paste)
    KeyCode.Power -> LogicalKey.Named(NamedKey.Power)
    KeyCode.Props -> LogicalKey.Named(NamedKey.Props)
    KeyCode.Select -> LogicalKey.Named(NamedKey.Select)
    KeyCode.Undo -> LogicalKey.Named(NamedKey.Undo)
    KeyCode.WakeUp -> LogicalKey.Named(NamedKey.WakeUp)
    KeyCode.BrightnessDown -> LogicalKey.Named(NamedKey.BrightnessDown)
    KeyCode.BrightnessUp -> LogicalKey.Named(NamedKey.BrightnessUp)
    KeyCode.LaunchApp1 -> LogicalKey.Named(NamedKey.LaunchApplication1)
    KeyCode.LaunchApp2 -> LogicalKey.Named(NamedKey.LaunchApplication2)
    KeyCode.LaunchMail -> LogicalKey.Named(NamedKey.LaunchMail)
    KeyCode.LaunchScreenSaver -> LogicalKey.Named(NamedKey.LaunchScreenSaver)
    KeyCode.MailForward -> LogicalKey.Named(NamedKey.MailForward)
    KeyCode.MailReply -> LogicalKey.Named(NamedKey.MailReply)
    KeyCode.MailSend -> LogicalKey.Named(NamedKey.MailSend)
    KeyCode.MediaFastForward -> LogicalKey.Named(NamedKey.MediaFastForward)
    KeyCode.MediaPause -> LogicalKey.Named(NamedKey.MediaPause)
    KeyCode.MediaPlay -> LogicalKey.Named(NamedKey.MediaPlay)
    KeyCode.MediaPlayPause -> LogicalKey.Named(NamedKey.MediaPlayPause)
    KeyCode.MediaRecord -> LogicalKey.Named(NamedKey.MediaRecord)
    KeyCode.MediaRewind -> LogicalKey.Named(NamedKey.MediaRewind)
    KeyCode.MediaStop -> LogicalKey.Named(NamedKey.MediaStop)
    KeyCode.MediaTrackNext -> LogicalKey.Named(NamedKey.MediaTrackNext)
    KeyCode.MediaTrackPrevious -> LogicalKey.Named(NamedKey.MediaTrackPrevious)
    KeyCode.MicrophoneMuteToggle -> LogicalKey.Named(NamedKey.MicrophoneVolumeMute)
