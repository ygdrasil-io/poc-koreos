...
La sous-tranche fullscreen, définie par
`APPKIT-PHASE-5-WINDOW-FULLSCREEN-DESIGN.md`, est achevée : AppKit prend en
charge le fullscreen natif `Borderless` corrélé aux notifications AppKit.
