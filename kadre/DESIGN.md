...
- `Manual` ignore le détachement DOM, y compris un detach/reinsert, et exige un `requestStop` explicite ; tant que son élément reste déconnecté, son lifecycle demeure `Background + Inactive`.
