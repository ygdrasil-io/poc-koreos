/**
 * Implémentation iOS arm64 (stub) de la boucle d'événements.
 *
...
/**
 * Implémentation iOS arm64 de [EventLoop].
 *
...
actual class EventLoop actual constructor() {
    ...
    actual fun runApp(handler: ApplicationHandler) {
        throw UnsupportedOperationException(
            "EventLoop iOS arm64 non implémenté — en attente d'un ticket dédié."
        )
    }
}
