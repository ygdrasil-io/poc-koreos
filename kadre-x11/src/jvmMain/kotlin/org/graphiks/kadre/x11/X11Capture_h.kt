...
internal val libXcomposite: SymbolLookup? by lazy {
    try {
...
internal const val XIMAGE_DATA_OFFSET: Long = 16L
internal const val XIMAGE_BYTES_PER_LINE_OFFSET: Long = 44L
internal const val XIMAGE_BITS_PER_PIXEL_OFFSET: Long = 48L
...
//   char* shmaddr                 @ 16 (8)
internal const val XSHM_SEGINFO_SIZE: Long = 24L
internal const val XSHM_SHMPIX_OFFSET: Long = 0L  // shmseg (XID)
internal const val XSHM_SHMD_OFFSET: Long = 8L     // shmid
internal const val XSHM_READONLY_OFFSET: Long = 12L
internal const val XSHM_ADDR_OFFSET: Long = 16L    // shmaddr pointer

// ── X11 constants ──────────────────────────────────────────────────────────────

internal const val Xlib_ZPixmap: Int = 2
internal const val Xlib_AllPlanes: Long = -1L

// XShmGetImage format constant (same as ZPixmap)
internal const val XSHM_ZPIXMAP: Int = 2

// XCompositeRedirect constants
internal const val CompositeRedirectAutomatic: Int = 1

// XGetWindowProperty constants
internal const val XGetPropertyDelete: Long = 1L
internal const val XGetPropertyKeep: Long = 0L
internal const val AnyPropertyType: Long = 0L

// shmget constants (Linux: IPC_CREAT = 01000 octal = 512 decimal)
internal const val IPC_PRIVATE: Int = 0
internal const val IPC_CREAT: Int = 512
internal const val IPC_RMID: Int = 0
...
//   map_state(4) = 84
internal const val XWINDOWATTR_MAP_STATE_OFFSET: Long = 84L
internal const val IsViewable: Int = 2

// NetWM constants
internal const val NET_WM_WINDOW_TYPE_NORMAL: Long = 0L
internal const val NET_WM_WINDOW_TYPE_DOCK: Long = 1L
internal const val NET_WM_WINDOW_TYPE_DIALOG: Long = 2L
internal const val NET_WM_WINDOW_TYPE_UTILITY: Long = 3L
internal const val NET_WM_WINDOW_TYPE_TOOLBAR: Long = 4L
internal const val NET_WM_WINDOW_TYPE_SPLASH: Long = 5L
internal const val NET_WM_WINDOW_TYPE_DESKTOP: Long = 6L

// ── FFM bindings: libXext (for MIT-SHM) ────────────────────────────────────────

internal val xShmQueryExtension: MethodHandle? by lazy {
...
internal val xShmCreateImage: MethodHandle? by lazy {
...
internal val xShmAttach: MethodHandle? by lazy {
...
internal val xShmDetach: MethodHandle? by lazy {
...
internal val xShmGetImage: MethodHandle? by lazy {
...
internal val xGetImage: MethodHandle? by lazy {
...
internal val xDestroyImage: MethodHandle? by lazy {
...
internal val xDefaultScreen: MethodHandle? by lazy {
...
internal val xDefaultRootWindow: MethodHandle? by lazy {
...
internal val xDefaultVisual: MethodHandle? by lazy {
...
internal val xDefaultDepth: MethodHandle? by lazy {
...
internal val xQueryTree: MethodHandle? by lazy {
...
internal val xGetWindowAttributes: MethodHandle? by lazy {
...
internal val xSync: MethodHandle? by lazy {
...
internal val xCompositeNameWindowPixmap: MethodHandle? by lazy {
...
internal val shmget: MethodHandle? by lazy {
...
internal val shmat: MethodHandle? by lazy {
...
internal val shmdt: MethodHandle? by lazy {
...
internal val shmctl: MethodHandle? by lazy {
