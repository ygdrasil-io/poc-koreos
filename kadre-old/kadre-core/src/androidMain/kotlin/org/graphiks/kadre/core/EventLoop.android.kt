/**
 * Android actual implementation of [EventLoop] (internal kadre-core stub).
 *
 ...
 * which delegates to the Android backend at runtime.
 */
actual class EventLoop actual constructor() {
    ...
    actual fun runApp(handler: ApplicationHandler) {
        throw UnsupportedOperationException(
            ...
            "Use the `kadre` module which delegates to the Android backend."
        )
    }
}
