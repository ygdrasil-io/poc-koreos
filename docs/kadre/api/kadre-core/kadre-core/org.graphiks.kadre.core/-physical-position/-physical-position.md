//[kadre-core](../../../index.md)/[org.graphiks.kadre.core](../index.md)/[PhysicalPosition](index.md)/[PhysicalPosition](-physical-position.md)

# PhysicalPosition

[common]\
constructor(x: [T](index.md), y: [T](index.md))
