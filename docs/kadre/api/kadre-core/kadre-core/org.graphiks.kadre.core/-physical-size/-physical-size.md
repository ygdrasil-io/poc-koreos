//[kadre-core](../../../index.md)/[org.graphiks.kadre.core](../index.md)/[PhysicalSize](index.md)/[PhysicalSize](-physical-size.md)

# PhysicalSize

[common]\
constructor(width: [T](index.md), height: [T](index.md))
