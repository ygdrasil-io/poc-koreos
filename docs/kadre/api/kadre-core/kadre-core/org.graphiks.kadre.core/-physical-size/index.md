//[kadre-core](../../../index.md)/[org.graphiks.kadre.core](../index.md)/[PhysicalSize](index.md)
...
| Name | Summary |
|---|---|
| [height](height.md) | [common]<br>val [height](height.md): [T](index.md)<br>Height in physical pixels. |
| [width](width.md) | [common]<br>val [width](width.md): [T](index.md)<br>Width in physical pixels. |
