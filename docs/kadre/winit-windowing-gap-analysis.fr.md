...
| Focus sur `Window` | `focusWindow`, `hasFocus` | implemented | API commune presente; AppKit et Win32 implementent le focus avec la garde winit `visible && !minimized && !foreground` quand applicable; les autres backends restent a valider finement. |
