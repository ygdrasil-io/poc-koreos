...
| Focus sur `Window` | `focusWindow`, `hasFocus` | implemented | API commune presente; AppKit implemente le focus avec la garde winit `visible && !minimized`, les autres backends restent a valider finement. |
